...
namespace GameDevKit.ObjectReferences
{
    ...
    public class SceneReference : ISerializationCallbackReceiver
    {
        ...
        public static bool operator ==(SceneReference sceneRef, Scene scene)
        {
            return sceneRef.scenePath == scene.path;
        }
        ...
        public static bool operator ==(Scene scene, SceneReference sceneRef)
        {
            return sceneRef == scene;
        }
        ...
        {
            if (other is not SceneReference)
            {
                return false;
            }

            return (other as SceneReference).scenePath == scenePath;
        }
    ...
    public class SceneReferencePropertyDrawer : PropertyDrawer
    {
        ...
        private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
        {
            ...
            {
                iconContent = EditorGUIUtility.IconContent("redLight");
            ...
            {
                iconContent = EditorGUIUtility.IconContent("greenLight");
            ...
            {
                iconContent = EditorGUIUtility.IconContent("orangeLight");
                labelContent.text = "BuildIndex: " + buildScene.buildIndex;
